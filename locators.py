...
class StellarBurgers:
    NAME_SELECTOR = (By.XPATH, "/html/body/div/div/main/div/form/fieldset[1]/div/div/input") # Поле ввода имени в фоме регистрации
    EMAIL_SELECTOR = (By.XPATH, "/html/body/div/div/main/div/form/fieldset[2]/div/div/input") # Поле ввода email в форме регистрации
    PASSWORD_SELECTOR = (By.XPATH, "/html/body/div/div/main/div/form/fieldset[3]/div/div/input") # Поле ввода пароля в форме регистрации
